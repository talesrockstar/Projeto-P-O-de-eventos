describe('Tela de feedback', () => {
  beforeEach(() => {
    cy.visit('feedback-manieri.html')
  })
  ...
  it('Carregar os elementos da tela corretamente', () => {
    ...
    cy.get('.nome_do_evento').should('have.text', 'Maurício Manieri - Tour Classics 2025')
    cy.get('.descricao_do_evento').should('contain.text', 'Maurício Manieri apresenta superprodução “Classics” pela primeira vez em Goiânia')
  })
