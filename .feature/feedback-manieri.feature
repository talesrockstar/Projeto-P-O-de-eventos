Feature: Tela de feedback-manieri
  ...
  Scenario: Carregar os elementos da tela corretamente
    ...
    And the event name should be "Maurício Manieri - Tour Classics 2025"
    And the event description should contain "Maurício Manieri apresenta superprodução “Classics” pela primeira vez em Goiânia"
